...
<body class="signinPage">
		...
		<div class="row">
			<div class="offset-md-6 offset-lg-5 offset-xl-4 col-sm-12 col-md-6 col-lg-4 col-xl-3">
				...
				<form id="formSignin" method="get">
					...
					<p class=" mx-sm-3 change">Not a member yet? <a href="/Projet_Web_tweet_academie/register">Register here</a></p>
				</form>
			</div>
		</div>
	</div>
	...
	<script src="/Projet_Web_tweet_academie/public/js/script.js"></script>
</body>
</html>